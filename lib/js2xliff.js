...
function createUnitTag (id, unit, options) {
  ...
  const srcVal = (unit.source === undefined && unit.target !== undefined) ? '' : unit.source
  ...
  if (unit.target !== undefined) segment.elements.push(makeElement('target', null, makeValue(unit.target, ElementTypes2, options && options.targetXliffVersion)))

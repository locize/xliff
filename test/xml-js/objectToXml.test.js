...
const ElementTypes = require('../../cjs/inline-elements/ElementTypes')
const ElementTypes12 = require('../../cjs/inline-elements/ElementTypes12')
const elementTypeToTag = require('../../cjs/inline-elements/typeToTagMaps').elementTypeToTag
const makeElement = require('../../cjs/xml-js/objectToXml').makeElement
const makeText = require('../../cjs/xml-js/objectToXml').makeText
const makeValue = require('../../cjs/xml-js/objectToXml').makeValue
